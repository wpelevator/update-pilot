...
class ComposerStaticInitUpdate_Pilot_Plugin
{
    ...
    public static $classMap = array (
        ...
        'WPElevator\\Update_Pilot\\Settings\\Field' => __DIR__ . '/../..' . '/php/settings/class-field.php',
        'WPElevator\\Update_Pilot\\Settings\\Field_Text' => __DIR__ . '/../..' . '/php/settings/class-field-text.php',
        'WPElevator\\Update_Pilot\\Settings\\Store' => __DIR__ . '/../..' . '/php/settings/class-store.php',
        'WPElevator\\Update_Pilot\\Settings\\Store_Site_Option' => __DIR__ . '/../..' . '/php/settings/class-store-site-option.php',
        'WPElevator\\Update_Pilot\\Settings\\Update_Key' => __DIR__ . '/../..' . '/php/settings/class-update-key.php',
        'WPElevator\\Update_Pilot\\Settings\\Vendor_Signing_Key' => __DIR__ . '/../..' . '/php/settings/class-vendor-signing-key.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitUpdate_Pilot_Plugin::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitUpdate_Pilot_Plugin::$prefixDirsPsr4;
